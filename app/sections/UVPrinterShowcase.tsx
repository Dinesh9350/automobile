...
const features = [
  { icon: Maximize2, text: 'Mimaki Digital 5 Feet Printer' },
  { icon: Zap, text: 'Grafica 32"x42" & 20"x30"' },
  { icon: Palette, text: 'In-House Color Development' },
  { icon: Check, text: 'Screen & Digital Printing' },
]
...
export default function InfrastructureShowcase() {
  ...
  return (
    <section ref={containerRef} id="infrastructure" className="relative py-32 bg-slate-950 overflow-hidden">
      ...
      <motion.div style={{ opacity }} className="section-padding max-w-7xl mx-auto relative">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-white/50 mb-8 leading-relaxed">
              Fully equipped with Mimaki Digital printers, Grafica offset machines, 
              IR dryers and in-house color shade development capabilities.
            </p>
          ...
          <motion.div style={{ y, scale }} className="relative">
            <div className="relative">
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-white font-bold text-lg">Mimaki UCJV300-160</div>
                      <div className="text-white/50 text-sm">Digital UV Printer</div>
                    </div>
              ...
              >
                <div className="text-2xl font-bold text-white">5 Feet</div>
                <div className="text-xs text-white/50">Print Width</div>
              </motion.div>
              ...
              >
                ...
                <div className="text-xs text-white/50">Printing Units</div>
              </motion.div> */}
            </div>
          </motion.div>
        </div>
